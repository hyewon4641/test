...
main.elf:main.c touch.h led.h libbuzzer.h fnd.h libBitmap.h colorledtest.h
	arm-linux-gnueabi-gcc --static -o main.elf main.c -l MyPeri -L. -lpthread
	
libMyPeri.a:colorledtest.c colorledtest.h touch.c touch.h led.h led.c buzzer.c libbuzzer.h fnd.c fnd.h libBitmap.c libBitmap.h bitmapFileHeader.h
	...
	arm-linux-gnueabi-ar rc libMyPeri.a led.o buzzer.o libBitmap.o fnd.o touch.o colorledtest.o
